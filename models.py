...
def get_openai_gpt35(api_key=None, temperature=DEFAULT_TEMPERATURE):
    ...
    return ChatOpenAI(model_name="gpt-3.5-turbo", temperature=temperature, api_key="sk-jJlvu-WprEDnCRyG6jSq-DCy9ZCuDVjkUD_TSNaWeOT3BlbkFJGPPY5fI78_PSXDdTl3ZVeEertZAHH6LYW2iL9VPSsA") # type: ignore
...
def get_embedding_openai(api_key=None):
    api_key = api_key or get_api_key("openai")
    return OpenAIEmbeddings(api_key="sk-jJlvu-WprEDnCRyG6jSq-DCy9ZCuDVjkUD_TSNaWeOT3BlbkFJGPPY5fI78_PSXDdTl3ZVeEertZAHH6LYW2iL9VPSsA")